...
module.exports = {
     ...
     * @param appendRealPath 附加绝对路径
     * @return {{}}
     */
    getDataSync: function(currentModule, contentKeys, config, defaultValue, appendRealPath) {
        ...
        if(currentModule && config['subModule'][currentModule]) {
            _.each(contentKeys, function(vm){
                ...
                if(fs.existsSync(dataPath)) {
                    ...
                    if(appendRealPath) {
                        data[vm] = {
                            text: getDataJSON(json, dataPath),
                            real: dataPath
                        };
                    } else {
