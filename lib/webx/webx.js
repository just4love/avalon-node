...
module.exports = {
     ...
     * @return {Object}
     */
    getKeys: function(contentList, config){
        var result = {};

        _.each(contentList, function(v, k){
            var forSetVars = kvconventer.getForSetVars(v),
                vars = kvconventer.getVars(v);

            kvconventer.mergeVars(vars, forSetVars, k, result)
        });
